<?php
    ...
    if (isset($_POST['btnsign'])) {
        ...
        //step 3 - query
        $query = "INSERT INTO `tblcustomer`(`CFName`, `CLName`, `CEmail`, `CPNumber`, `CPassword`) VALUES ('$firstname','$lastname','$email','$phone_number','$password')";
...
<div class="container">
	...
	<!-- back to login page -->
	<div class="form-group">
	    <a href="loginPage.php" class="button">Go to Login Page</a>
            <a href="homepage.php" class="btnhome">Back to Home Page</a>
	</div>
    </form>
