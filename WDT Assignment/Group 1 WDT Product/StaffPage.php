    ...
    <div class="container">
        <div id="menu">
            <div id="nav"> 
                ...
                <ul>
                    <li> <a style="text-decoration: none" href="loginPage.php" >Login </a></li>
                    <li> <a style="text-decoration: none" href="SignupPage.php" >Sign up </a></li>
                </ul>
                <ul>
...
<main>
  ...
  <tr>
    <td>
      ...
      <img src="images/Caregiverodlmanbed.png" id="Staffimage">
      <?php
...
?>
    ...
    <td>
      ...
      <img src="images/Caregiveroldmanbed.png" id="Staffimage">
      <?php
...
?>
    ...
    <td>
      ...
      <img src="images/Caregiveroldmanwheelchaircentre.png" id="Staffimage">
      <?php
