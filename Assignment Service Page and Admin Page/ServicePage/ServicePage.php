...
<div id="Accommodation tab" class="info-area">
  <h2>Accommodation</h2>
    ...
    <a href="AccomodationPage.php" class="link-style" id="AccommodationLink" >Go to Accommodation Page</a>
</div>
    ...
    <a href="StaffPage.php" class="link-style" id="StaffLink">Go to Staff Page</a> 
    </div>
    ...
    <a href="ActivitiesPage.php" class="link-style" id="ActivitiesLink">Go to Activities Page</a>
    </div>
  </main>
    </div>
</body>
